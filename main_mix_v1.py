...
# from discriminator_model_debugging import Discriminator
# from discriminator_model_1024_x3 import Discriminator

# from generator_model_replacement_debugging import Generator
# from discriminator_model_1024_x3_increase_decrease import Discriminator

# from generator_model_replacement_debugging import Generator
# from generator_model_replacement_debugging_withoutnorm import Generator
# from discriminator_model_debugging_withoutnorm import Discriminator
# from discriminator_model_1024_x3_withoutnorm import Discriminator
# from discriminator_model_1024_x3 import Discriminator

from generator_model_replacement_debugging_groupnorm import Generator
# from generator_model_replacement_debugging import Generator

# from gen_test import Generator
from discriminator_model_debugging import Discriminator


# from discriminator_model_debugging_groupnorm import Discriminator

# from discriminator_model_debugging_withoutnorm import Discriminator
# from discriminator_model_1024_x2 import Discriminator
# from discriminator_model_1024_x3_increase_decrease import Discriminator
...
def train_fn(disc, gen, loader, opt_disc, opt_gen, l1, bce, runtime_log_folder, runtime_log_file_name):
    ...
    for idx, (x, y) in enumerate(loader):
        ...
        # D_real = disc(disc_input_real.detach())
        # print("D_real")
        # print(D_real)

        disc_input_fake = torch.cat([x, y_fake], dim=1)
        # print("Disc Input Fake")
        # print(disc_input_fake)
        # print("Disc Input Fake Detach")
        # print(disc_input_fake.detach())
        D_fake = disc(disc_input_fake.detach())
        # D_fake = disc(disc_input_fake)
        # print("D_fake")
        # print(D_fake)
        ...
        # G_fake_loss = 10 * bce(D_fake, torch.ones_like(D_fake))
        ...
        # output_value = y_fake * 0.5 + 0.5 # remove normalization
        # print("Output y fake remove normalization")
        # print(output_value)
        # print()
        # print()
        # print("Output y_fake")
