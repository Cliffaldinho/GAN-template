...
# generator model layer 1024 replacement debugging
...
class Generator(nn.Module):
    def __init__(self, in_channels=3, features=64):
        ...
        self.initial_down = nn.Sequential(
            ...
            #nn.Conv2d(in_channels, features, 3, 1, padding = 'valid'),
            nn.LeakyReLU(0.2),
        )
        ...
        self.down8 = Block(features * 8, features * 8, down=True, act='leaky',
                           use_dropout='False')
        #print("down8: ",self.down7)
        ...
        self.up4 = Block(features * 8 * 2, features * 8, down=False, act='relu', use_dropout=True)  # out = 512
        #print("decoder up3: ", self.up3)
        self.up5 = Block(features * 8 * 2, features * 8, down=False, act='relu', use_dropout=False)  # out = 512
        #print("decoder up4: ", self.up4)
        self.up6 = Block(features * 8 * 2, features * 8, down=False, act='relu', use_dropout=False)  # out = 256
        #print("decoder up5: ", self.up5)
        self.up7 = Block(features * 8 * 2, features * 4, down=False, act='relu', use_dropout=False)  # out = 128
        #print("decoder up6: ", self.up6)
        self.up8 = Block(features * 4 * 2, features * 2, down=False, act='relu', use_dropout=False)  # out = 64
        #print("decoder up7: ", self.up7)
        self.up9 = Block(features * 2 * 2, features, down=False, act='relu', use_dropout=False)  # out = 64
