...
class Generator(nn.Module):
    def __init__(self, in_channels=3, features=64):
        ...
        self.initial_down = nn.Sequential(
            nn.Conv2d(in_channels, features, 3, 1, 1, padding_mode="reflect"),  # out = 64, dim = 128 x 128
            nn.LeakyReLU(0.2),
        )
    ...
    def forward(self, x):
        ...
        #print("concatenated 7 (last) shape: ",c7.shape)
        up8 = self.final_up(c7)
        #print("up 8 (final up) c7 and conved shape: ", up8.shape)
        #print()
